/*
  ...
  1. Changes
    - Add islands data for Haa Alifu and Haa Dhaalu atolls
    - Fix island category to match check constraint
*/
...
-- Add airport category to Hanimaadhoo after initial insert
UPDATE islands 
SET 
  island_category = 'މީހުން ދިރިއުޅޭ ، އިންޓަރނޭޝަނަލް އެއަރޕޯޓް',
