...
CREATE POLICY "Users can upload to public buckets." ON storage.objects
...
DROP INDEX IF EXISTS storage.bname_idx;
DROP INDEX IF EXISTS storage.objects_bucket_id_idx;
DROP INDEX IF EXISTS storage.objects_name_idx;
DROP INDEX IF EXISTS storage.objects_owner_idx;
DROP INDEX IF EXISTS storage.objects_created_at_idx;
